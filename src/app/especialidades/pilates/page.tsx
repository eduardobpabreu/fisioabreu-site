    ...
    <div>
      ...
      <section className="relative h-[40vh] flex items-center">
        ...
        <div className="container relative z-10 text-white">
          ...
          Transforme seu corpo e mente com o Pilates. Uma abordagem única que combina força, flexibilidade e consciência corporal para uma vida mais saudável.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              <p>
                Nosso espaço de Pilates é dedicado ao fortalecimento, alongamento e equilíbrio corporal, promovendo bem-estar e qualidade de vida. Com aulas personalizadas, conduzidas por profissionais qualificados, ajudamos você a melhorar a postura, aumentar a flexibilidade e reduzir o estresse. Venha experimentar a transformação que o Pilates pode trazer para seu corpo e mente!
              </p>
              <p>
              Aceitamos os seguintes convênios: GEAP. Caso não possua nenhum destes planos, favor entrar em contato para consultar os valores.
              </p>
              <Link 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card p-0 overflow-hidden">
              <div className="p-6 h-24">
                <h3 className="text-xl font-semibold text-[#017761]">Postura corrigida</h3>
              </div>
              <div className="relative h-48">
                <Image
                  src="/images/especialidades/pilates1.png"
                  alt="Postura corrigida"
                  fill
            ...
            <div className="card p-0 overflow-hidden">
              <div className="p-6 h-24">
                <h3 className="text-xl font-semibold text-[#017761]">Flexibilidade</h3>
              </div>
              <div className="relative h-48">
                <Image
                  src="/images/especialidades/pilates2.png"
                  alt="Flexibilidade"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 25vw"
            ...
            <div className="card p-0 overflow-hidden">
              <div className="p-6 h-24">
                <h3 className="text-xl font-semibold text-[#017761]">Fortalecimento muscular</h3>
              </div>
              <div className="relative h-48">
                <Image
                  src="/images/especialidades/pilates3.png"
            ...
            <div className="card p-0 overflow-hidden">
              <div className="p-6 h-24">
                <h3 className="text-xl font-semibold text-[#017761]">Redução de estresse</h3>
              </div>
              <div className="relative h-48">
                <Image
                  src="/images/especialidades/pilates4.png"
                  alt="Redução de estresse"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 25vw"
                />
