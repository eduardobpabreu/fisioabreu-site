    ...
    <div>
      ...
      <section className="relative h-[40vh] flex items-center">
        ...
        <div className="container relative z-10 text-white">
          ...
          Reeducação Postural Global: uma abordagem revolucionária para tratar problemas posturais e musculoesqueléticos de forma integrada e personalizada.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              <p>
              A Reeducação Postural Global (RPG) é um método eficaz para alinhar o corpo e corrigir desequilíbrios posturais, aliviando dores e prevenindo lesões. Nossa equipe especializada realiza sessões individuais e personalizadas que tratam cada caso de forma única, trazendo alívio e conforto ao seu dia a dia. Agende uma consulta e descubra os benefícios de uma postura saudável e equilibrada!
              </p>
              <p>
              Aceitamos os seguintes convênios: Assefaz, Bradesco, Cassi, MediService, Petrobras, Postal Saúde e Saúde Moinhos. Caso não possua nenhum destes planos, favor entrar em contato para consultar os valores.
              </p>
              <Link 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card p-0 overflow-hidden">
              <div className="p-6 h-24">
                <h3 className="text-xl font-semibold text-[#017761]">Alinhamento postural</h3>
              </div>
              <div className="relative h-48">
                <Image
                  src="/images/especialidades/rpg1.png"
                  alt="Alinhamento postural"
                  fill
            ...
            <div className="card p-0 overflow-hidden">
              <div className="p-6 h-24">
                <h3 className="text-xl font-semibold text-[#017761]">Alívio de dores</h3>
              </div>
              <div className="relative h-48">
                <Image
                  src="/images/especialidades/rpg2.png"
                  alt="Alívio de dores"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 25vw"
            ...
            <div className="card p-0 overflow-hidden">
              <div className="p-6 h-24">
                <h3 className="text-xl font-semibold text-[#017761]">Prevensão de lesões</h3>
              </div>
              <div className="relative h-48">
                <Image
                  src="/images/especialidades/rpg3.png"
                  alt="Prevensão de lesões"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 25vw"
                />
            ...
            <div className="card p-0 overflow-hidden">
              <div className="p-6 h-24">
                <h3 className="text-xl font-semibold text-[#017761]">Mobilidade aprimorada</h3>
              </div>
              <div className="relative h-48">
                <Image
                  src="/images/especialidades/rpg4.png"
                  alt="Mobilidade aprimorada"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 25vw"
                />
